...
$header_content_h1 = "
	...
	line-height: 1.2;
";
$header_img = kodiak_get_option( 'kodiak_giftcard_email_header_image', '' );
$heading    = KODIAK_GIFTCARDS()->emails->get_heading();
				...
				<td align="center" valign="top">
					<?php if( ! empty( $header_img ) ) : ?>
						<div id="template_header_image">
							<?php echo '<p style="margin-top:0;"><img src="' . esc_url( $header_img ) . '" alt="' . get_bloginfo( 'name' ) . '" style="max-width:200px; height: auto;" /></p>'; ?>
						</div>
					<?php endif; ?>
